...
public class UploadFileServlet extends HttpServlet {
  ...
  // public static final String SAVE_DIRECTORY = "D:\\subjects\\web\\CodeFeDashBoardHostHeroku\\src\\main\\webapp\\Product_img";
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("menu/addmenu.jsp");
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
          ...
          // }
           ...
           // 
           request.setAttribute("successMess", "Upload successfully!! ");
           RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/menu/addmenu.jsp");
           dispatcher.forward(request, response);
       } catch (Exception e) {
           e.printStackTrace();
